...
{
    /***
     *  It if preferrable to use the ROS tf matrix to rpy conversion as it
     * appears to be more accurate (sign issues). There are so many Euler angles
     * its hard to tell when something is correct.
    */
