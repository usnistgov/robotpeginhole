...
#include "guardedmove_plugin/guardedmove_plugin.h"
...
namespace gazebo
{
    ...
    ////////////////////////////////////////////////////////////////////////////////
    GuardedMovePlugin ::VirtualJoint::VirtualJoint(GuardedMovePlugin *p,
                                                   physics::JointPtr j,
    ...
    ////////////////////////////////////////////////////////////////////////////////
    bool GuardedMovePlugin ::VirtualJoint::CheckValidity(VirtualJoint *v)
    {
#if 0
    ...
    ////////////////////////////////////////////////////////////////////////////////
    GuardedMovePlugin ::GuardedMovePlugin()
    {
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void GuardedMovePlugin ::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
    {
        try
        {
            ...
            std::cout << "GuardedMovePlugin : Compiled " << __DATE__ << " " << __TIME__ << "\n"
                      << std::flush;
            std::cout << "GuardedMovePlugin : Model plugin: " << model_name << "\nJoints:\n"
                      << std::flush;
            ...
            std::cout << "GuardedMovePlugin  Model = " << model_name << "\n";
            std::cout << "GuardedMovePlugin  Namespace = " << robot_namespace << "\n";
            std::cout << "GuardedMovePlugin  Joint1 = " << joint1_name << "\n";
            std::cout << "GuardedMovePlugin  Joint2 = " << joint2_name << "\n";
            std::cout << "GuardedMovePlugin  Link1 = " << link1_name << "\n";
            std::cout << "GuardedMovePlugin  Link2 = " << link2_name << "\n";
            std::cout << "GuardedMovePlugin  Service Control Topic = " << control_topic << "\n";
            std::cout << "GuardedMovePlugin  Debug = " << bDebug << "\n";
            std::cout << "GuardedMovePlugin  Synchronous = " << bSynchronous << "\n";
            ...
            this->updateConnection = event::Events::ConnectWorldUpdateBegin(boost::bind(&GuardedMovePlugin ::onUpdate, this, _1));
            ...
            if (bCollisions)
            {
                ...
                bool latching = false;
                this->contactSub = this->node->Subscribe(contacttopic, &GuardedMovePlugin ::OnContact, this, latching);
            }
            // Fix...
            if (bDebug)
            ...
            grip_service = rosnode->advertiseService(control_topic, &GuardedMovePlugin ::OnGripperCommand, this);
        ...
        {
            gzerr << "Exception GuardedMovePlugin ::Load" << e.what() << "\n";
        }
        catch (...)
        {
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void GuardedMovePlugin ::OnContact(const ConstContactsPtr &_msg)
    {
        ...
        {
            gzerr << "Exception GuardedMovePlugin ::OnContact" << e.what() << "\n";
        }
        catch (...)
        {
    ...
    ////////////////////////////////////////////////////////////////////////////////
    bool GuardedMovePlugin ::OnGripperCommand(std_srvs::SetBool::Request &_req,
    ...
    ////////////////////////////////////////////////////////////////////////////////
    void GuardedMovePlugin ::onUpdate(const common::UpdateInfo & /*_info*/)
    {
        try
        {
#ifdef TIMED_UPDATE
        ...
        {
            gzerr << "Exception GuardedMovePlugin ::onUpdate" << e.what() << "\n";
        }
        catch (...)
        {
            gzerr << "Exception GuardedMovePlugin ::onUpdate\n";
        }
        //publishGripperState();
    }
    ////////////////////////////////////////////////////////////////////////////////
    //void GuardedMovePlugin ::publishGripperState()
    //{
    ...
    void GuardedMovePlugin ::Detach()
    {
        ...
        {
            gzerr << "Exception GuardedMovePlugin ::Detach" << e.what() << "\n";
        }
        catch (...)
        {
            gzerr << "Exception GuardedMovePlugin ::Detach()\n";
        }
    }

    ////////////////////////////////////////////////////////////////////////////////
    int GuardedMovePlugin ::CheckAttach()
    {
        std::lock_guard<std::mutex> lockGuard(mymutex);
        ...
        {
            gzerr << "Exception GuardedMovePlugin ::CheckAttach" << e.what() << "\n";
        }
        catch (...)
        {
            gzerr << "Exception GuardedMovePlugin ::CheckAttach()\n";
        }
        return this->virtualJoints.size();
    }

    ////////////////////////////////////////////////////////////////////////////////
    void GuardedMovePlugin ::SetLinksGravityFlag(physics::ModelPtr objmodel, bool bFlag)
    {
        try
        {
        ...
        {
            gzerr << "Exception GuardedMovePlugin ::SetLinksGravityFlag" << e.what() << "\n";
        }
        catch (...)
        {
            gzerr << "Exception GuardedMovePlugin ::SetLinksGravityFlag()\n";
        }
    }
}
